      ...
      >
        ...
        <div className="text-center mb-8">
          <motion.div
            ...
            className="inline-block p-4 bg-gradient-to-br from-accent-cyan to-accent-purple rounded-2xl mb-4"
          >
        ...
        {/* Login Card */}
        <div className="bg-primary-card border border-accent-cyan/20 rounded-2xl p-8 shadow-2xl">
          {/* Header */}
          ...
          <div className="mt-6 text-center">
            <button
              onClick={toggleMode}
              disabled={loading}
              className="text-sm text-text-secondary hover:text-accent-cyan transition-colors disabled:opacity-50"
            >
              {isSignUp ? (
                <>
